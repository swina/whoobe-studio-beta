<template>
    <div>
        <div ref="sideNav" :class="'bm-menu ' + $attrs.el.css.responsive">
            ...
            <span class="bm-cross-button cross-style absolute top-0 right-0 m-4 text-2xl" @click="closeMenu" :class="{ hidden: !crossIcon }">
        ...
        <div ref="bmBurgerButton" class="bm-burger-button top-0 left-0 m-4 w-10 h-8 " @click="openMenu" :class="{ hidden: !burgerIcon }">
