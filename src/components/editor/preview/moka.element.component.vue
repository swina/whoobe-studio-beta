<template>
    <span>
        <component  v-if="el && !el.hasOwnProperty('plugin')" :ref="el.id" :is="component" :style="el.style" :class="css" :el="el" :child="child" :attrib="$attrs"/> 
        <moka-plugin-wrapper v-if="el && el.hasOwnProperty('plugin')" :settings="el.plugin.editor.settings"  :block="el"  :plugin="el" :component="el.plugin.component"/></span>
</template>
