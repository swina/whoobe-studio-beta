<template>
    <div class="w-full flex flex-col">
        ...
        <!-- image -->
        <div class="bg-gray-200 text-sm cursor-pointer border-b hover:bg-black hover:text-white text-gray-800 px-1" v-if="$attrs.entity && $attrs.entity.entity.hasOwnProperty('image')" @click="setOpt('image'),image=!image">
            Media
        </div>
        ...
        <!-- <div class="bg-gray-200 cursor-pointer border-b hover:bg-black hover:text-white text-gray-800 px-1 mt-0" v-if="$attrs.entity && editor.current.tag != 'document'" @click="setOpt('semantic'),semantic=!semantic">
            HTML Semantic
        </div>
        <moka-options 
            class="mb-0" 
