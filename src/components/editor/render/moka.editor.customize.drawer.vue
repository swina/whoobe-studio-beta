<template>
    <div :data="component" class="w-full relative bg-gray-800 h-screen overflow-y-auto z-2xtop mb-2 shadow">
        <div v-if="$attrs.element && entity && entity.entity" class="absolute top-0 left-0 overflow-y-auto h-auto w-full  z-2xtop h-screen">
