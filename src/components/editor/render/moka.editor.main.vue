...
<div>
    <div :class="'top-0 right-0 left-0 bottom-0 flex mb-20 flex-row '" v-if="$attrs.component && hasblocks && !preview">
        ...
        <div class="w-full overflow-y-auto overflow-x-hidden">
            ...
            <div class="flex flex-col fixed bottom-0 right-0 mb-10 text-sm bg-gray-200 w-1/3 lg:w-1/4 p-2 cursor-pointer z-2xtop" v-if="docOptions" @mouseleave="docOptions=!docOptions">
                ...
                <div class="p-1 hover:bg-white" @click="$store.dispatch('loading'),exportComponent=!exportComponent">Export</div>
                <div class="p-1 hover:bg-white" @click="settings=!settings">Settings</div>
            </div>
 ...
 title="Select document">border_clear</i>
                    ...
                    <i v-if="editor.current && editor.current.tag==='document'" class="material-icons moka-icons nuxpresso-icon-circle text-gray-300 ml-2" @click="grids=!grids" title="Add block">grid_on</i>
 ...
 title="Save document">save</i>
    ...
    <transition name="slideright">
        ...
        <!-- <div class="fixed w-1/4 right-0 bottom-0 mt-8 flex flex-col shadow-lg p-2 pt-4 bg-white z-2xtop text-base" v-if="settings"> -->
        <moka-modal
            v-if="settings"
                ...
                <div class="p-2 bg-gray-200 rounded">
                    ...
                    <div v-if="bodySettings">
                        ...
                        <select class="w-full" v-model="fontFamily">
                            ...
                            <!-- <option v-for="gfont in editor.fonts">{{gfont}}</option> -->
