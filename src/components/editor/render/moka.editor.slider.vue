<template>
    <div v-if="slider">
        <div class="flex flex-col text-sm my-2 bg-gray-200 rounded p-1">
            ...
            <div v-if="context==='slider' && slider[context]" class="flex flex-row">
                <label class="ml-2">Slide/Animation duration secs</label>
                <input class="w-6" type="number" min="1" max="100000" title="Set 0 to disable autoplay" v-model="slider[context].delay"/>
            </div>
            ...
            <div v-if="context==='gallery' && slider[context]" class="flex flex-row">
