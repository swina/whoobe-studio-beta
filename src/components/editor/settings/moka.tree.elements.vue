<template>
        <ul :class="'tree'" >
            <li class="border-0 pl-1 list-none hover:bg-gray-200 flex py-1 items-center">
            ...
            <li v-if="expand" :class="'list-none pl-' + (parseInt($attrs.level)+1)" :key="block.id" v-for="(block,b) in doc.blocks">
                ...
                <div class="border flex items-center mb-1 py-1 hover:bg-gray-200" v-if="block && !block.hasOwnProperty('blocks')" @click="setCurrent(block)">
