<template>
    <div class="w-full flex flex-col">
        ...
        <!-- image -->
        <div class="bg-gray-800 text-sm cursor-pointer border-b border-gray-700 hover:bg-gray-700 hover:text-white text-gray-500 p-1" v-if="editor.current && editor.current.hasOwnProperty('image')" @click="setOpt('image'),image=!image">
            Media
        </div>
        <div class="p-2 text-center border-b border-gray-700" v-if="editor.current && editor.current.hasOwnProperty('image')">
