<template> 
    <div :key="refreshID" :ref="doc.id" :class="pageCss(doc.css) + ' m-auto overflow-y-auto z-highest overflow-x-hidden '" :style="stile(doc,true) + ' ' + background(doc)" id="content">
        ...
        <moka-slider :key="doc.id" v-if="doc.hasOwnProperty('slider')" :develop="true" :embeded="true" :doc="doc" :editor="false"/>        
