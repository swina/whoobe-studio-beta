/**
 * This is a simple js plugin test (better think as a module) to load external
 * scripts and inject in whoobe app after build. It should work like a plugin.
 * @key String : Snipcart API KEY 
 */
